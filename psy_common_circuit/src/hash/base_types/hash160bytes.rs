...
pub fn read_hash160_bytes_target_from_array(targets: &[Target], offset: usize) -> Hash160BytesTarget {
...
pub trait CircuitBuilderHash160Bytes<F: RichField + Extendable<D>, const D: usize> {
    ...
    fn select_hash160_bytes(&mut self, b: BoolTarget, x: Hash160BytesTarget, y: Hash160BytesTarget) -> Hash160BytesTarget;
    fn hash160_bytes_to_hash160(&mut self, x: Hash160BytesTarget) -> Hash160Target;
    fn hash160_bytes_from_u32_bits(&mut self, u32_bits: &[[BoolTarget; 32]; 5]) -> Hash160BytesTarget;
}

impl<F: RichField + Extendable<D>, const D: usize> CircuitBuilderHash160Bytes<F, D> for CircuitBuilder<F, D> {
    fn add_virtual_hash160_bytes_target(&mut self) -> Hash160BytesTarget {
        // TODO: range check u8?
