...
impl CheckpointStatsRepository {
    ...
    pub async fn get_by_checkpoint_id(pool: &PgPool, checkpoint_id: i64) -> Result<Option<CheckpointStats>> {
        let record = sqlx::query_as!(
            CheckpointStats,
            r#"
    ...
    pub async fn get_by_checkpoint_range(pool: &PgPool, start_checkpoint: i64, end_checkpoint: i64) -> Result<Vec<CheckpointStats>> {
...
impl WorkerJobEventRepository {
    ...
    pub async fn create_batch(pool: &PgPool, events: &[CreateWorkerJobEvent]) -> Result<Vec<WorkerJobEvent>> {
    ...
    pub async fn get_by_checkpoint(pool: &PgPool, checkpoint_id: i64) -> Result<Vec<WorkerJobEvent>> {
        let records = sqlx::query_as!(
            WorkerJobEvent,
            r#"
    ...
    pub async fn count_jobs_by_checkpoint(pool: &PgPool, checkpoint_id: i64) -> Result<i64> {
...
impl CheckpointRewardDistributionRepository {
    ...
    pub async fn create(pool: &PgPool, distribution: &CreateCheckpointRewardDistribution) -> Result<CheckpointRewardDistribution> {
    ...
    pub async fn create_batch(pool: &PgPool, distributions: &[CreateCheckpointRewardDistribution]) -> Result<Vec<CheckpointRewardDistribution>> {
    ...
    pub async fn get_by_checkpoint(pool: &PgPool, checkpoint_id: i64) -> Result<Vec<CheckpointRewardDistribution>> {
        let records = sqlx::query_as!(
            CheckpointRewardDistribution,
            r#"
    ...
    pub async fn get_checkpoint_summary(pool: &PgPool, checkpoint_id: i64) -> Result<Option<CheckpointRewardSummary>> {
...
impl CheckpointRewardAggregationRepository {
    ...
    pub async fn get_worker_stats(pool: &PgPool, worker_public_key: &str) -> Result<Option<WorkerCheckpointRewardStats>> {
        let record = sqlx::query!(
            r#"
            SELECT
                worker_public_key,
