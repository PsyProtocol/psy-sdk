...
-- --------------------------------------------------------------------
-- Purpose:
--   Maintain latest job status for each unique job_id
--   Provide aggregated job status statistics by overall and by realm
-- --------------------------------------------------------------------

-- ===============================================================
-- 1. Create materialized view: latest_job_status
--    Keeps only the most recent row for each job_id
-- ===============================================================
...
-- ===============================================================
-- 2. Indexes for latest_job_status
-- ===============================================================
...
-- ===============================================================
-- 3. Function: refresh_latest_job_status()
--    Safely refresh materialized view concurrently
-- ===============================================================
...
-- ===============================================================
-- 4. View: job_status_summary
--    Provides percentage of each job status (global)
-- ===============================================================
...
-- ===============================================================
-- 5. View: job_status_summary_by_realm
--    Same summary, grouped by realm_id
-- ===============================================================
...
SELECT
    ...
    ROUND(
            100.0 * COUNT(*) /
            NULLIF(SUM(COUNT(*)) OVER (PARTITION BY realm_id), 0),
            2)
        AS percentage,
    MAX(timestamp) AS last_update
FROM latest_job_status
...
-- ===============================================================
-- 6. Function: get_job_status_summary(time_window)
--    Optional function to query summary by time range
-- ===============================================================
