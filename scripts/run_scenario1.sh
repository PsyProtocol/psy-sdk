...
SCENARIO_LOG="$LOG_DIR/scenario1.log"
...
log_message "Starting Scenario 1..."
...
# register 4094 users, block 4 - 36
run_make_command "make TOTAL_USER=4094 random-register-user-batch" "Register 4094 User"
sleep 5
...
run_make_command "make claim2" "Claim2"
CURRENT_BLOCK=$((CURRENT_BLOCK + 1))
run_make_command "make build-block" "Build Block $CURRENT_BLOCK"
sleep 5
CURRENT_BLOCK=$((CURRENT_BLOCK + 1))
...
run_make_command "make return-back2" "return-back2"
CURRENT_BLOCK=$((CURRENT_BLOCK + 1))
run_make_command "make build-block" "Build Block $CURRENT_BLOCK"
sleep 5
CURRENT_BLOCK=$((CURRENT_BLOCK + 1))
...
log_message "Scenario 1 completed successfully."
