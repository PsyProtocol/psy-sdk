...
LOG_LEVEL=${LOG_LEVEL:-"psy_ups_circuit=trace,psy_dpn_circuit=trace,psy_user_cli=debug,psy_prover=trace"}
...
${YELLOW}Environment Variables:${NC}
    LOG_LEVEL      Rust log level (default: psy_ups_circuit=trace,psy_dpn_circuit=trace,psy_user_cli=debug,psy_prover=trace)
