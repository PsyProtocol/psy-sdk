...
mod tests {
    use super::*;
    use crate::crypto::{bn254::pairing_config, kzg::{CircuitBuilderKZG, fft::CircuitBuilderFFT}};
    use plonky2::{
    ...
    fn test_kzg_commitment_structure() {
        ...
        use crate::crypto::kzg::{setup::KZGSetup, fft::CircuitBuilderFFT};
    ...
    fn test_kzg_linear_polynomial() {
        ...
        // We can't predict the exact evaluation without computing Lagrange interpolation
    ...
    fn test_kzg_debug_zero_inversion() {
        use crate::crypto::bn254::gadgets::pairing::{AffinePointTargetG2, CircuitBuilderCurveG2};
        use crate::crypto::kzg::setup::KZGSetup;
        use crate::crypto::secp256k1::ecdsa::curve::curve_types::{AffinePoint, CurveScalar};
    ...
    fn test_pairing_with_g1_infinity() {
        use crate::crypto::bn254::gadgets::pairing::{AffinePointTargetG2, CircuitBuilderCurveG2, CircuitBuilderPairing};
        use crate::crypto::bn254::{curve::{g1::G1, g2::G2}, field::bn128_base::Bn128Base};
