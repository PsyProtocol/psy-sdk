...
//!   cargo run --example websocket_client -- --channels worker_events,user_events,tps
...
async fn main() -> Result<()> {
    ...
    println!("{}", "╔══════════════════════════════════════════════════════════╗".cyan().bold());
    println!("{}", "║     QED API WebSocket Client - Testing Tool              ║".cyan().bold());
    println!("{}", "╚══════════════════════════════════════════════════════════╝".cyan().bold());
    println!();
    ...
    let mut test_timer = if args.test_mode {
        Some(interval(Duration::from_secs(10)))
    } else {
        None
    };
