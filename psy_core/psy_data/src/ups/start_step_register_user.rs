...
pub struct UPSStartStepRegisterUserInput<F: RichField> {
    ...
    pub user_registration_tree_proof: MerkleProofCore<QHashOut<F>>,
}

impl<F: RichField> KVQSerializable for UPSStartStepRegisterUserInput<F> {
