...
async fn execute_transfer_multi_transaction_sync(
    ...
    let private_key_to1 = QHashOut::<GoldilocksField>::rand();
    let private_key_to2 = QHashOut::<GoldilocksField>::rand();
    ...
    contract_call_args.push(ContractCallArgs {
        ...
        inputs: vec![user_id_to1, transfer_amount],
    });
    contract_call_args.push(ContractCallArgs {
        contract_id: 0,
        method_name: "simple_transfer".to_string(),
        inputs: vec![user_id_to2, transfer_amount],
    });
    // contract_call_args.push(ContractCallArgs {
    //     contract_id: 0,
    //     method_name: "simple_transfer".to_string(),
    //     inputs: vec![user_id_to3, transfer_amount],
    // });
