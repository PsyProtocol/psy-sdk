...
>(&mut self, edge: &CoordinatorEdgeContext<SR,DQ,PS>, start_registration_id: u64, user_private_keys: &[QHashOut<F>]) -> anyhow::Result<Vec<u64>>{
    ...
    DQ: CheckpointDrainQueueEmitterAsyncImm + TxPoolAsyncImmV2,
    PS: QProofStoreAsyncImm + TxPoolAsyncImmV2,
