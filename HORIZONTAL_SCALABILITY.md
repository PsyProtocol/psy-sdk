...
1.  **Granular State:** Instead of one global state tree, QED maintains a hierarchy of Merkle trees, most notably:
...
Key terms:
DPN - Dapen, the code name for the QED rust smart contract language
