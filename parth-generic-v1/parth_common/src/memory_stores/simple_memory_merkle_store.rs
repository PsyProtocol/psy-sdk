...
use parth_core::{crypto::hash::{merkle_proof::{DeltaMerkleProofCore, MerkleProofCore}, spiderman::SpidermanUpdateProof, traits::MerkleZeroHasher}, data::hash::merkle_node_key::SimpleMerkleNodeKey, utils::math::ceil_div_usize};
...
mod tests {
    ...
    use super::SimpleMemoryMerkleStore;
    ...
    fn test_merkle_tree_sha256() {
        ...
        let mut simple_tree = SimpleMemoryMerkleStore::<Hasher, Hash>::new(12);

        let values = [
            (0, Hash256::from_u64_le_values(1337, 123, 555, 1273)),
            (133, Hash256::from_u64_le_values(15, 12, 1, 3)),
            (1, Hash256::from_u64_le_values(5, 123, 555, 22)),
            (19, Hash256::from_u64_le_values(1337, 123, 4, 11)),
        ];
    ...
    #[test]
    fn test_merkle_tree_sha256_big() {
        type Hash = Hash256;
        type Hasher = CoreSha256Hasher;
        let mut simple_tree = SimpleMemoryMerkleStore::<Hasher, Hash>::new(50);

        let values = [
            (0, Hash256::from_u64_le_values(1337, 123, 555, 1273)),
            (123812937128, Hash256::from_u64_le_values(15, 12, 1, 3)),
            (1, Hash256::from_u64_le_values(5, 123, 555, 22)),
            (1124149, Hash256::from_u64_le_values(1337, 123, 4, 11)),
        ];
    ...
    fn test_rehash_tree() {
        ...
        let mut tree_a = SimpleMemoryMerkleStore::<H, Hash256>::new(12);
        let mut tree_b = SimpleMemoryMerkleStore::<H, Hash256>::new(12);
    ...
    fn test_append_spiderman_simple(top_line_height: usize, web_tree_height: usize, append_leaf_ct: usize, start_index: usize) {
        ...
        let mut tree = SimpleMemoryMerkleStore::<CoreSha256Hasher, Hash256>::new(total_height as u8);
        ...
        for p in spiderman_proofs.iter() {
            assert!(p.verify::<CoreSha256Hasher>(), "invalid spiderman proof");
        }
    }
    #[test]
