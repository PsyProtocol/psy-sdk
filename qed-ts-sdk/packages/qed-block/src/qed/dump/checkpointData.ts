...
async function getLeafCountOrDummy(
    ...
    const counterJobId = getJobSubGroupCounterGoalId(newCoreOpWitnessJobId(circuitType, checkpointId, 0));
...
export { getProofStoreConfigForCheckpoint, getLeafCountOrDummy, getProofStoreConfigPS };
