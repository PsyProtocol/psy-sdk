...
export const wasmrpcserver_prove_contract_call_json: (
    a: number,
    b: number,
    c: number
) => [number, number, number, number];
export const wasmrpcserver_prove_contract_calls_json: (
    a: number,
    b: number,
    c: number
) => [number, number, number, number];
...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h748cf0f517aabec2: (
    a: number,
    b: number
) => void;
export const closure1468_externref_shim: (a: number, b: number, c: any) => void;
