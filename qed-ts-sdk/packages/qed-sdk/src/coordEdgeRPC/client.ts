...
export class CoordinatorEdgeRpcProvider extends Provider implements ICoordinatorEdgeRpcProvider {
    ...
    /**
     * Creates a new instance of the Enhanced Coordinator Edge RPC Provider
    ...
    async getCheckpointLeafData(checkpointId: number): Promise<QEDCheckpointLeaf> {
        return this.rpc<QEDCheckpointLeaf>(CoordinatorEdgeRPCCommand.GetCheckpointLeafData, [
    ...
    async getCheckpointLeafDataF(checkpointId: bigint): Promise<QEDCheckpointLeaf> {
        return this.rpc<QEDCheckpointLeaf>(CoordinatorEdgeRPCCommand.GetCheckpointLeafDataF, [
            { checkpoint_id: checkpointId },
        ]);
    }
    ...
    async getContractCodeDefinition(contractId: number): Promise<ContractCodeDefinition> {
        return this.rpc<ContractCodeDefinition>(CoordinatorEdgeRPCCommand.GetContractCodeDefinition, [
    ...
    async getContractCodeDefinitionF(contractId: bigint): Promise<ContractCodeDefinition> {
        return this.rpc<ContractCodeDefinition>(CoordinatorEdgeRPCCommand.GetContractCodeDefinitionF, [
            { contract_id: contractId },
        ]);
    }
    ...
    async getUserRegistrationTreeRoot(checkpointId: number): Promise<QHashOut> {
        return this.rpc<QHashOut>(CoordinatorEdgeRPCCommand.GetUserRegistrationTreeRoot, [
            { checkpoint_id: checkpointId },
        ]);
    }

    async getUserRegistrationTreeRootF(checkpointId: bigint): Promise<QHashOut> {
        return this.rpc<QHashOut>(CoordinatorEdgeRPCCommand.GetUserRegistrationTreeRootF, [
            { checkpoint_id: checkpointId },
        ]);
    }
    ...
    async getCheckpointSyncInfoCompact(checkpointId: number): Promise<QEDCheckpointSyncInfoCompact> {
        return this.rpc<QEDCheckpointSyncInfoCompact>(CoordinatorEdgeRPCCommand.GetCheckpointSyncInfoCompact, [
            checkpointId,
        ]);
    }
