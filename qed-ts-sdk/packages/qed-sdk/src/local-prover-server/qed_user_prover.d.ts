...
export interface InitOutput {
  ...
  readonly wasmrpcserver_prove_contract_call_json: (a: number, b: number, c: number) => [number, number, number, number];
  readonly wasmrpcserver_prove_contract_calls_json: (a: number, b: number, c: number) => [number, number, number, number];
  ...
  readonly wasmrpcserver_get_zk_public_key_json: (a: number, b: number, c: number) => [number, number, number, number];
  ...
  readonly wasmrpcserver_get_deploy_contract_cmd_json: (a: number, b: number, c: number) => [number, number, number, number];
  ...
  readonly wasmrpcserver_get_end_cap_proof_json: (a: number, b: number, c: number) => [number, number, number, number];
  ...
  readonly closure1256_externref_shim: (a: number, b: number, c: any) => void;
