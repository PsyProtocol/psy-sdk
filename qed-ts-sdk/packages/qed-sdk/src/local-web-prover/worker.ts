    ...
    private async executeMethod(method: string, params: any[]): Promise<any> {
        ...
        switch (method) {
            case QedUserProverRPCCommand.ExecContractCall:
                return this.wasmServer.exec_contract_call_json(params[0], QedJSON.stringify(params[1]));
            ...
            case QedUserProverRPCCommand.ProveContractCall:
                return this.wasmServer.prove_contract_call_json(params[0], QedJSON.stringify(params[1]));
            
            case QedUserProverRPCCommand.ProveContractCalls:
                return this.wasmServer.prove_contract_calls_json(params[0], QedJSON.stringify(params[1]));
            ...
            case QedUserProverRPCCommand.DeployContract:
                return this.wasmServer.deploy_contract_json(params[0], QedJSON.stringify(params[1]));
            
            case QedUserProverRPCCommand.GetDeployContractCmd: {
                const deployResult = await this.wasmServer.get_deploy_contract_cmd_json(params[0], QedJSON.stringify(params[1]));
...
const proverServer = new QedProverServer();
