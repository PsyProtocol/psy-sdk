...
export const config = {
    ...
    logging: {
        ...
        rustLogLevel: process.env.RUST_LOG || 'qed_user_cli=debug,qed_dev_cli=debug,qed_rollup_cli=debug,psy_node=debug,psy_common_circuit=debug,psy_network_circuit=debug,psy_prover=debug,psy_data=debug,plonky2=error',
    }
};
