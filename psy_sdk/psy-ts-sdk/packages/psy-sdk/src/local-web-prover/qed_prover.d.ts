...
export interface InitOutput {
  ...
  readonly closure1717_externref_shim: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h49d6426062092f7e: (a: number, b: number) => void;
  readonly closure2116_externref_shim: (a: number, b: number, c: any, d: any) => void;
