...
pub fn get_merkle_proofs_for_compact<Hasher: MerkleZeroHasher<Hash>, Hash: Copy + PartialEq + Default + Debug>(from_index: u64, siblings: &[Hash], values: &[Hash]) -> Vec<MerkleProofCore<Hash>> {
