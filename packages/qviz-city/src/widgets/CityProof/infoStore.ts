...
const VariantDefs: Record<ProvingJobCircuitType, ProofWidgetStyleVariant> = {
  ...
  [ProvingJobCircuitType.DummyRegisterUserAggregate]: ProofWidgetStyleVariant.Standard,
  [ProvingJobCircuitType.DummyAddL1DepositAggregate]: ProofWidgetStyleVariant.Standard,
  [ProvingJobCircuitType.DummyClaimL1DepositAggregate]: ProofWidgetStyleVariant.Standard,
  [ProvingJobCircuitType.DummyTransferTokensL2Aggregate]: ProofWidgetStyleVariant.Standard,
  [ProvingJobCircuitType.DummyAddL1WithdrawalAggregate]: ProofWidgetStyleVariant.Standard,
  [ProvingJobCircuitType.DummyProcessL1WithdrawalAggregate]: ProofWidgetStyleVariant.Standard,
