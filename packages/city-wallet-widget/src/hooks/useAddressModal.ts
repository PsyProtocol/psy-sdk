...
interface IAddressModalState {
  ...
  openModal: (modalType: AddressModalType, activeModalData?: any, eventListeners?: IAddressModalEventListeners) => any;
  cancelModal: ()=>any;
  completeModal: (resultData?: any, newModalType?: AddressModalType, newActiveModalData?: any, eventListeners?: IAddressModalEventListeners) => any;
...
const useAddressModal = create<IAddressModalState>((set, get) => ({
  ...
  openModal: (modalType: AddressModalType, activeModalData?: any, eventListeners: IAddressModalEventListeners = {}) => set((state) =>{
  ...
  completeModal: (resultData?: any, newModalType: AddressModalType = AddressModalType.Closed, newActiveModalData: any = {}, eventListeners: IAddressModalEventListeners = {}) => set((state) =>{
    const currentState = get();
    if(currentState.activeModalType === AddressModalType.Closed){
      return {}
    }else{
