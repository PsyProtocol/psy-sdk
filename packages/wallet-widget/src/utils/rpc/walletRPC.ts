import {DogeLinkElectrsRPC, DogeLinkRPC, DogeNetworkId, IAddressStatsResponse, IBasicBlock, IBlockStatus, IDogeLinkElectrsRPC, IDogeLinkRPC, IDogeNetwork, IGetTXResponse, IMempoolRecentTransaction, IMempoolStatus, IScriptHashStatsResponse, ITransactionOutSpend, IUTXO, Transaction} from 'doge-sdk';
...
class WalletWidgetRPC implements IWalletWidgetRPC {
  ...
  getTransactionsFor(addressOrScriptHash: string, confirmed?: boolean | undefined, afterTxid?: string | undefined): Promise<IGetTXResponse[]> {
  ...
  waitUntilUTXO(address: string, pollInterval?: number | undefined, maxAttempts?: number | undefined): Promise<IUTXO[]> {
