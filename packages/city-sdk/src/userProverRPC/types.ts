...
interface ICityUserProverProvider extends ICityWalletProver {
  ...
  proveSecp256K1Signature(publicKey: HexString, signature: HexString, message: Hash256, maxAttempts?: number, delay?: number): Promise<HexString>;
  proveZKSignature(privateKey: Hash256, message: Hash256, maxAttempts?: number, delay?: number): Promise<HexString>;
  proveZKSignatureEnc(encryptedPrivateKey: Hash256, message: Hash256, salt: Hash256, maxAttempts?: number, delay?: number): Promise<HexString>;
  getZKPublicKey(privateKey: Hash256, maxAttempts?: number, delay?: number): Promise<HexString>;
  getZKPublicKeyEnc(encryptedPrivateKey: Hash256, salt: Hash256, maxAttempts?: number, delay?: number): Promise<HexString>;
