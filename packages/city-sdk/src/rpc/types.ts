...
type GetUserIdsForPublicKeyRequest = ICityRPCCommandRequest<CityRPCCommand.GetUserIdsForPublicKey, {public_key: CityHash}>;
type GetUserByIdRequest = ICityRPCCommandRequest<CityRPCCommand.GetUserById, ICheckpointIdAndUserIdRequest>;
type GetUserMerkleProofByIdRequest = ICityRPCCommandRequest<CityRPCCommand.GetUserMerkleProofById, ICheckpointIdAndUserIdRequest>;
type GetUserTreeLeafRequest = ICityRPCCommandRequest<CityRPCCommand.GetUserTreeLeaf, ICheckpointIdAndLeafIdRequest>;
type GetUserTreeLeafMerkleProofRequest = ICityRPCCommandRequest<CityRPCCommand.GetUserTreeLeafMerkleProof, ICheckpointIdAndLeafIdRequest>;
...
type GetDepositLeafMerkleProofRequest = ICityRPCCommandRequest<CityRPCCommand.GetDepositLeafMerkleProof, ICheckpointIdAndDepositIdRequest>;
...
type GetCityBlockDepositAddressRequest = ICityRPCCommandRequest<CityRPCCommand.GetCityBlockDepositAddress, ICheckpointIdRequest>;
type GetCityBlockDepositAddressStringRequest = ICityRPCCommandRequest<CityRPCCommand.GetCityBlockDepositAddressString, ICheckpointIdRequest>;
type GetWithdrawalTreeRootRequest = ICityRPCCommandRequest<CityRPCCommand.GetWithdrawalTreeRoot, ICheckpointIdRequest>;
type GetWithdrawalByIdRequest = ICityRPCCommandRequest<CityRPCCommand.GetWithdrawalById, ICheckpointIdAndWithdrawalIdRequest>;
type GetWithdrawalsByIdRequest = ICityRPCCommandRequest<CityRPCCommand.GetWithdrawalsById, ICheckpointIdAndWithdrawalIdsRequest>;
type GetWithdrawalHashRequest = ICityRPCCommandRequest<CityRPCCommand.GetWithdrawalHash, ICheckpointIdAndWithdrawalIdRequest>;
type GetWithdrawalLeafMerkleProofRequest = ICityRPCCommandRequest<CityRPCCommand.GetWithdrawalLeafMerkleProof, ICheckpointIdAndWithdrawalIdRequest>;
type GetProofStoreValueRequest = ICityRPCCommandRequest<CityRPCCommand.GetProofStoreValue, ICheckpointIdAndProofStoreKeyRequest>;
type GetProofStoreValuesRequest = ICityRPCCommandRequest<CityRPCCommand.GetProofStoreValues, ICheckpointIdAndProofStoreKeysRequest>;
...
type CityRPCCommandRequest = GetUserTreeRootRequest | GetUserIdsForPublicKeyRequest | GetUserByIdRequest | GetUserMerkleProofByIdRequest | GetUserTreeLeafRequest | GetUserTreeLeafMerkleProofRequest | GetDepositTreeRootRequest | GetDepositByIdRequest | GetDepositsByIdRequest | GetDepositByTxidRequest | GetDepositsByTxidRequest | GetDepositHashRequest | GetDepositLeafMerkleProofRequest | GetBlockStateRequest | GetLatestBlockStateRequest | GetCityRootRequest | GetCityBlockScriptRequest | GetCityBlockDepositAddressRequest | GetCityBlockDepositAddressStringRequest | GetWithdrawalTreeRootRequest | GetWithdrawalByIdRequest | GetWithdrawalsByIdRequest | GetWithdrawalHashRequest | GetWithdrawalLeafMerkleProofRequest | GetProofStoreValueRequest | GetProofStoreValuesRequest | RegisterUserRequest | AddWithdrawalRequest | ClaimDepositRequest | TokenTransferRequest | ProduceBlockRequest;
