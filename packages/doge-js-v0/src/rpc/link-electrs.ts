...
import { IDogeLinkRPCInfo, IUTXO } from "../types/network";
import { waitMs } from "../utils/core";
import { DogeLinkRPC } from "./link";
...
class DogeLinkElectrsRPC extends DogeLinkRPC {
  electrsURL: string;
  constructor(rpcInfo: IDogeLinkRPCInfo | string, electrsURL: string, httpClient: IDogeHTTPClient = fetchHTTPClient) {
    super(rpcInfo);
