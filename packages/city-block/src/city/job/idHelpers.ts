...
function getBlockAggregateJobsGroupJobId(
  block_id: number,
  group_id: number,
  task_index: number,
): IQProvingJobDataID {
...
function notifyBlockCompleteJobId(
  block_id: number,
): IQProvingJobDataID {
  return {
...
function blockAggStatePart1InputWitnessJobId(
  block_id: number,
): IQProvingJobDataID {
  return {
    topic: QJobTopic.GenerateStandardProof,
...
function blockAggStatePart2InputWitnessJobId(
  block_id: number,
): IQProvingJobDataID {
  return {
    topic: QJobTopic.GenerateStandardProof,
...
function blockStateTransitionInputWitnessJobId(
  block_id: number,
): IQProvingJobDataID {
  return {
    topic: QJobTopic.GenerateStandardProof,
...
function sighashIntrospectionInputWitnessJobId(
  block_id: number,
  input_id: number,
): IQProvingJobDataID {
  return {
...
function sighashFinalInputWitnessJobId(
  block_id: number,
  input_id: number,
): IQProvingJobDataID {
  return {
...
function wrapSighashFinalBls3812InputWitnessJobId(
  block_id: number,
  input_id: number,
): IQProvingJobDataID {
  return {
...
function isNotifyOrchestratorCompleteJobId(
  jobId: IQProvingJobDataID,
): boolean {
  return jobId.topic === QJobTopic.NotifyOrchestratorComplete;
}

function getJobOutputId(
  jobId: IQProvingJobDataID,
): IQProvingJobDataID {
  return {
    ...jobId,
...
function getJobSubGroupCounterId(
  jobId: IQProvingJobDataID,
): IQProvingJobDataID {
  return {
    ...jobId,
...
function getJobSubGroupCounterGoalId(
  jobId: IQProvingJobDataID,
): IQProvingJobDataID {
  return {
    ...jobId,
...
function getSubGroupCounterGoalNextJobsId(
  jobId: IQProvingJobDataID,
): IQProvingJobDataID {
  return {
    ...jobId,
