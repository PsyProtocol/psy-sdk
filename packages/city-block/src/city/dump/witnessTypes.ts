import { CityDeltaMerkleProof, CityMerkleProof } from "@qstudio/city-sdk";
...
interface IAggUserRegisterClaimDepositL2TransferJobWitness extends ICRAggUserRegisterClaimDepositL2TransferCircuitInput, IBaseJobWitness {
  q_witness_type: "AggUserRegisterClaimDepositL2Transfer",
}

interface IAggAddProcessL1WithdrawalAddL1DepositJobWitness extends ICRAggAddProcessL1WithdrawalAddL1DepositCircuitInput, IBaseJobWitness {
...
type ICityJobWitness = IRegisterUserJobWitness | IRegisterUserAggregateJobWitness | IAddL1DepositJobWitness | IAddL1DepositAggregateJobWitness | IClaimL1DepositJobWitness | IClaimL1DepositAggregateJobWitness | ITransferTokensL2JobWitness | ITransferTokensL2AggregateJobWitness | IAddL1WithdrawalJobWitness | IAddL1WithdrawalAggregateJobWitness | IProcessL1WithdrawalJobWitness | IProcessL1WithdrawalAggregateJobWitness | IGenerateRollupStateTransitionProofJobWitness | IGenerateSigHashIntrospectionProofJobWitness | IGenerateFinalSigHashProofJobWitness | IWrapFinalSigHashProofBLS12381JobWitness | IAggUserRegisterClaimDepositL2TransferJobWitness | IAggAddProcessL1WithdrawalAddL1DepositJobWitness | IDummyRegisterUserAggregateJobWitness | IDummyAddL1DepositAggregateJobWitness | IDummyClaimL1DepositAggregateJobWitness | IDummyTransferTokensL2AggregateJobWitness | IDummyAddL1WithdrawalAggregateJobWitness | IDummyProcessL1WithdrawalAggregateJobWitness;
