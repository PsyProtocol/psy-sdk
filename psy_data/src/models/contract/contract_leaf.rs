...
use crate::{
    ...
    qdata::{checkpoint_id_key::CheckpointTableIdKey, contract::QEDContractLeaf},
};
...
>
{
    fn get_contract_by_id(store: &S, checkpoint_id: u64, contract_id: u64) -> anyhow::Result<QEDContractLeaf<QEDFelt>> {
    ...
    fn get_contracts_by_id(store: &S, checkpoint_id: u64, contract_ids: &[u64]) -> anyhow::Result<Vec<QEDContractLeaf<QEDFelt>>> {
...
impl<const CONTRACT_LEAF_TABLE_TYPE: u16, S, IDKVA: KVQStoreAdapter<S, CheckpointTableIdKey<CONTRACT_LEAF_TABLE_TYPE>, QEDContractLeaf<QEDFelt>>>
