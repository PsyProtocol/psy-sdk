...
use crate::{
    config::store_config::{QEDHash, QEDHasher, QUserPublicKeyRecord},
...
>
{
    fn get_first_user_for_public_key_hash_if_exists(store: &S, public_key: QEDHash) -> anyhow::Result<Option<QUserPublicKeyRecord>> {
...
{
    fn delete_user_public_key_record(store: &mut S, user_id: u64, public_key: QEDHash) -> anyhow::Result<Option<QUserPublicKeyRecord>> {
