...
#[derive(Debug)]
pub struct StateReader<F: RichField + Extendable<D>, const D: usize, R: PsyReadCommandProcessorSync<F> + psy_data::qstore::imm::cmd_processor::QUserIdManager + Send + Sync> {
    pub state: UserContractState<F>,
...
impl<F: RichField + Extendable<D>, const D: usize, R: PsyReadCommandProcessorSync<F> + psy_data::qstore::imm::cmd_processor::QUserIdManager + Send + Sync> StateReader<F, D, R> {
