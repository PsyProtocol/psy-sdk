use qed_ast::{
    AttrNode, ExprId, IdentId, Location, NodeInfo, NodeType, Qualifier, TypeQualifier, Visibility,
};
...
impl CheckedFunctionParameter {
    pub fn new(name: IdentId, qualifier: TypeQualifier, ty: TypeId, location: Location) -> Self {
        Self {
            name,
            qualifier,
            ty,
