...
use psy_data::{
    config::store_config::{QEDHash, QEDHasher},
...
> = KVQFixedConfigMerkleTreeModel<TREE_ID, HEIGHT, 0, 0, LOCAL_PROVING_SESSION_TREE_TABLE_TYPE, false, S, IDKVA, QEDHash, QEDHasher>;

pub const LPS_DEFERRED_TRANSACTION_TREE_ID: u8 = 1;

pub type LPSDeferredTransactionTreeStore<S, IDKVA = KVQStandardAdapter<S, KVQMerkleNodeKey<LOCAL_PROVING_SESSION_TREE_TABLE_TYPE>, QEDHash>> =
