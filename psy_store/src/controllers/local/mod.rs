...
use crate::controllers::local::proving_session::PsyLocalProvingSessionStore;
...
pub async fn prepare_environment_with_real_contract(
...
) -> Result<PsyLocalProvingSessionStore<PsyFelt, KVQSimpleMemoryBackingStore>> {
    ...
    let final_checkpoint_id = PsyFelt::from_canonical_u64(latest_l2_block_state.checkpoint_id);
