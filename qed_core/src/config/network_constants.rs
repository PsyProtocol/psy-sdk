...
pub const GLOBAL_USER_TREE_HEIGHT: u8 = 30;
pub const COORDINATOR_USER_TREE_HEIGHT: u8 = 15;
pub const REALM_USER_TREE_HEIGHT: u8 = 15;

pub const GUTA_PROOF_MAX_TREE_HEIGHT: u8 = 16;
