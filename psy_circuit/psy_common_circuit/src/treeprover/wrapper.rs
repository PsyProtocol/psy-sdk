...
impl<AC: QStandardCircuit<C, D>, C: 'static + GenericConfig<D>, const D: usize> TreeProverLeafCircuitWrapper<AC, C, D>
where
    C::Hasher: AlgebraicHasher<C::F>,
{
...
impl<AC, C: 'static + GenericConfig<D>, const D: usize> QStandardCircuit<C, D> for TreeProverLeafCircuitWrapper<AC, C, D>
where
    C::Hasher: AlgebraicHasher<C::F>,
{
...
impl<AC: QStandardCircuitWithDefault + QStandardCircuit<C, D>, C: 'static + GenericConfig<D>, const D: usize> QStandardCircuitWithDefaultMinified
...
impl<AC: QStandardCircuitWithDefault + QStandardCircuit<C, D>, C: 'static + GenericConfig<D>, const D: usize> Clone
    for TreeProverLeafCircuitWrapper<AC, C, D>
where
    C::Hasher: AlgebraicHasher<C::F>,
{
...
impl<
        ...
        C: GenericConfig<D>,
        const D: usize,
    > QStandardCircuitProvableWithProofStoreSync<S, I, C, D> for TreeProverLeafCircuitWrapper<SC, C, D>
where
    C::Hasher: AlgebraicHasher<C::F>,
{
