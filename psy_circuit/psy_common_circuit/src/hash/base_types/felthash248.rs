...
pub trait CircuitBuilderFelt248Hash<F: RichField + Extendable<D>, const D: usize> {
    ...
    fn connect_full_hashout_to_felt248_hashout(&mut self, standard_hashout: HashOutTarget, felt248_hashout: HashOutTarget);
}

impl<F: RichField + Extendable<D>, const D: usize> CircuitBuilderFelt248Hash<F, D> for CircuitBuilder<F, D> {
    fn hash256_bytes_to_felt248_hashout(&mut self, value: Hash256BytesTarget) -> HashOutTarget {
