    ...
    C::Hasher:AlgebraicHasher<C::F>,
{
    pub fn new() -> Self {
        ...
        builder.add_psy_type_e_common_gates();
...
mod tests {
    ...
    use psy_common::{config::network_constants::{PSY_NETWORK_MAGIC, UPS_CIRCUIT_WHITELIST_TREE_HEIGHT, UPS_SESSION_PROOF_TREE_HEIGHT}, data::qhashout::QHashOut};
