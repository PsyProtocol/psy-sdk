...
impl BatchAppendUserRegistrationTreeGadget {
    pub fn add_virtual_to<H: AlgebraicHasher<F>, F: RichField + Extendable<D>, const D: usize>(
        ...
        let first_spiderman_gadget = SpidermanAppendProofGadget::add_virtual_to::<H, F, D>(builder, top_line_height, batch_sub_tree_height);
        ...
        for _ in 1..max_sub_trees {
            let gadget = SpidermanAppendProofGadget::add_virtual_to::<H, F, D>(builder, top_line_height, batch_sub_tree_height);
