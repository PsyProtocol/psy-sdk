...
impl DPNOpType {
    ...
    pub fn eval_binary_constant(&self, a: u64, b: u64) -> u64 {
        ...
        match self {
            DPNOpType::Add => (GoldilocksField::from_canonical_u64(a)
                + GoldilocksField::from_canonical_u64(b))
            .to_canonical_u64(),
            DPNOpType::Sub => (GoldilocksField::from_canonical_u64(a)
                - GoldilocksField::from_canonical_u64(b))
            .to_canonical_u64(),
            DPNOpType::Mul => (GoldilocksField::from_canonical_u64(a)
                * GoldilocksField::from_canonical_u64(b))
            .to_canonical_u64(),
            DPNOpType::Div => (GoldilocksField::from_canonical_u64(a)
                / GoldilocksField::from_canonical_u64(b))
            .to_canonical_u64(),
    ...
    pub fn eval_unary_constant(&self, a: u64) -> u64 {
        ...
        match self {
            ...
            DPNOpType::UnaryInverse => GoldilocksField::from_noncanonical_u64(a)
                .inverse()
                .to_canonical_u64(),
            DPNOpType::UnaryNegative => GoldilocksField::from_noncanonical_u64(a)
                .neg()
                .to_canonical_u64(),
