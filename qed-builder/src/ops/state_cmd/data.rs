...
impl<T: Copy + Clone + Hash + Ord> DPNStateCmdCore<T>
    for DPNStateCmdGetSelfUserCurrentContractStateSlotHash<T>
{
    fn get_inputs(&self) -> Vec<T> {
        vec![self.slot_index]
    }
...
impl<T: Copy + Clone + Hash + Ord> DPNStateCmdCore<T>
    for DPNStateCmdGetSelfUserCurrentContractStateSlotSingle<T>
{
    fn get_inputs(&self) -> Vec<T> {
...
impl<T: Copy + Clone + Hash + Ord> DPNStateCmdCore<T>
    for DPNStateCmdGetSelfUserCurrentContractStateSlotRange<T>
{
    fn get_inputs(&self) -> Vec<T> {
        vec![self.sub_slot_index]
    }
...
impl<T: Ord + Hash + Clone + Copy> DPNStateCmdCore<T>
    for DPNStateCmdGetSelfUserExternalContractStateSlotHash<T>
{
    fn get_inputs(&self) -> Vec<T> {
...
impl<T: Ord + Hash + Clone + Copy> DPNStateCmdCore<T>
    for DPNStateCmdGetSelfUserExternalContractStateSlotSingle<T>
{
    fn get_inputs(&self) -> Vec<T> {
...
impl<T: Ord + Hash + Clone + Copy> DPNStateCmdCore<T>
    for DPNStateCmdGetSelfUserExternalContractStateSlotRange<T>
{
    fn get_inputs(&self) -> Vec<T> {
        vec![self.contract_id, self.sub_slot_index]
    }
...
impl<T: Ord + Hash + Clone + Copy> DPNStateCmdCore<T>
    for DPNStateCmdGetOtherUserContractStateSlotHash<T>
{
    fn get_inputs(&self) -> Vec<T> {
...
impl<T: Ord + Hash + Clone + Copy> DPNStateCmdCore<T>
    for DPNStateCmdGetOtherUserContractStateSlotSingle<T>
{
    fn get_inputs(&self) -> Vec<T> {
...
impl<T: Ord + Hash + Clone + Copy> DPNStateCmdCore<T>
    for DPNStateCmdGetOtherUserContractStateSlotRange<T>
{
    fn get_inputs(&self) -> Vec<T> {
        vec![self.user_id, self.contract_id, self.sub_slot_index]
    }
...
pub enum DPNStateCmd<T> {
    ...
    GetSelfUserCurrentContractStateSlotRange(
        DPNStateCmdGetSelfUserCurrentContractStateSlotRange<T>,
    ),
    GetSelfUserExternalContractStateSlotHash(
        DPNStateCmdGetSelfUserExternalContractStateSlotHash<T>,
    ),
    GetSelfUserExternalContractStateSlotSingle(
        DPNStateCmdGetSelfUserExternalContractStateSlotSingle<T>,
    ),
    GetSelfUserExternalContractStateSlotRange(
        DPNStateCmdGetSelfUserExternalContractStateSlotRange<T>,
    ),
...
impl<T> DPNStateCmd<T> {
    ...
    pub fn invoke_external_contract_function(
        condition: T,
        contract_id: T,
        method_id: T,
        input_args: Vec<T>,
    ...
    pub fn get_self_user_current_contract_state_slot_hash(slot_index: T) -> Self {
        DPNStateCmd::GetSelfUserCurrentContractStateSlotHash(
            DPNStateCmdGetSelfUserCurrentContractStateSlotHash::<T>::new(slot_index),
        )
    }
    pub fn get_self_user_current_contract_state_slot_single(sub_slot_index: T) -> Self {
        DPNStateCmd::GetSelfUserCurrentContractStateSlotSingle(
            DPNStateCmdGetSelfUserCurrentContractStateSlotSingle::<T>::new(sub_slot_index),
        )
    }
    pub fn get_self_user_current_contract_state_slot_range(sub_slot_index: T, length: u32) -> Self {
        DPNStateCmd::GetSelfUserCurrentContractStateSlotRange(
            DPNStateCmdGetSelfUserCurrentContractStateSlotRange::<T>::new(sub_slot_index, length),
        )
    }
    pub fn get_self_user_external_contract_state_slot_hash(
        ...
        DPNStateCmd::GetSelfUserExternalContractStateSlotHash(
            DPNStateCmdGetSelfUserExternalContractStateSlotHash::<T>::new(
                contract_id,
                contract_state_tree_height,
                slot_index,
            ),
    ...
    pub fn get_self_user_external_contract_state_slot_single(
        ...
        DPNStateCmd::GetSelfUserExternalContractStateSlotSingle(
            DPNStateCmdGetSelfUserExternalContractStateSlotSingle::<T>::new(
                contract_id,
                contract_state_tree_height,
                sub_slot_index,
            ),
    ...
    pub fn get_self_user_external_contract_state_slot_range(
        ...
        DPNStateCmd::GetSelfUserExternalContractStateSlotRange(
            DPNStateCmdGetSelfUserExternalContractStateSlotRange::<T>::new(
                contract_id,
                contract_state_tree_height,
                sub_slot_index,
                length,
    ...
    pub fn get_other_user_contract_state_slot_hash(
        ...
        DPNStateCmd::GetOtherUserContractStateSlotHash(
            DPNStateCmdGetOtherUserContractStateSlotHash::<T>::new(
                user_id,
                contract_id,
                contract_state_tree_height,
                slot_index,
    ...
    pub fn get_other_user_contract_state_slot_single(
        ...
        DPNStateCmd::GetOtherUserContractStateSlotSingle(
            DPNStateCmdGetOtherUserContractStateSlotSingle::<T>::new(
                user_id,
                contract_id,
                contract_state_tree_height,
                sub_slot_index,
    ...
    pub fn get_other_user_contract_state_slot_range(
        ...
        DPNStateCmd::GetOtherUserContractStateSlotRange(
            DPNStateCmdGetOtherUserContractStateSlotRange::<T>::new(
                user_id,
                contract_id,
                contract_state_tree_height,
                sub_slot_index,
    ...
    pub fn convert_to_u64(&self, inputs_as_u64: &[u64]) -> DPNStateCmd<u64> {
        match self {
            ...
            DPNStateCmd::GetSelfUserCurrentContractStateSlotHash(c) => {
                DPNStateCmd::GetSelfUserCurrentContractStateSlotHash(
                    DPNStateCmdGetSelfUserCurrentContractStateSlotHash::<u64>::new(
                        inputs_as_u64[0],
                    ),
                )
            }
            DPNStateCmd::GetSelfUserCurrentContractStateSlotSingle(c) => {
                DPNStateCmd::GetSelfUserCurrentContractStateSlotSingle(
                    DPNStateCmdGetSelfUserCurrentContractStateSlotSingle::<u64>::new(
                        inputs_as_u64[0],
                    ),
                )
            }
            DPNStateCmd::GetSelfUserCurrentContractStateSlotRange(c) => {
                DPNStateCmd::GetSelfUserCurrentContractStateSlotRange(
                    DPNStateCmdGetSelfUserCurrentContractStateSlotRange::<u64>::new(
                        inputs_as_u64[0],
                        c.length,
                    ),
                )
            ...
            DPNStateCmd::GetSelfUserExternalContractStateSlotHash(c) => {
                DPNStateCmd::GetSelfUserExternalContractStateSlotHash(
                    DPNStateCmdGetSelfUserExternalContractStateSlotHash::<u64>::new(
                        inputs_as_u64[0],
            ...
            DPNStateCmd::GetSelfUserExternalContractStateSlotSingle(c) => {
                DPNStateCmd::GetSelfUserExternalContractStateSlotSingle(
                    DPNStateCmdGetSelfUserExternalContractStateSlotSingle::<u64>::new(
                        inputs_as_u64[0],
                        c.contract_state_tree_height,
                        inputs_as_u64[1],
                    ),
            ...
            DPNStateCmd::GetSelfUserExternalContractStateSlotRange(c) => {
                DPNStateCmd::GetSelfUserExternalContractStateSlotRange(
                    DPNStateCmdGetSelfUserExternalContractStateSlotRange::<u64>::new(
                        inputs_as_u64[0],
                        c.contract_state_tree_height,
                        inputs_as_u64[1],
                        c.length,
            ...
            DPNStateCmd::GetOtherUserContractStateSlotHash(c) => {
                DPNStateCmd::GetOtherUserContractStateSlotHash(
                    DPNStateCmdGetOtherUserContractStateSlotHash::<u64>::new(
                        inputs_as_u64[0],
                        inputs_as_u64[1],
                        c.contract_state_tree_height,
                        inputs_as_u64[2],
            ...
            DPNStateCmd::GetOtherUserContractStateSlotSingle(c) => {
                DPNStateCmd::GetOtherUserContractStateSlotSingle(
                    DPNStateCmdGetOtherUserContractStateSlotSingle::<u64>::new(
                        inputs_as_u64[0],
                        inputs_as_u64[1],
                        c.contract_state_tree_height,
                        inputs_as_u64[2],
            ...
            DPNStateCmd::GetOtherUserContractStateSlotRange(c) => {
                DPNStateCmd::GetOtherUserContractStateSlotRange(
                    DPNStateCmdGetOtherUserContractStateSlotRange::<u64>::new(
                        inputs_as_u64[0],
                        inputs_as_u64[1],
                        c.contract_state_tree_height,
                        inputs_as_u64[2],
