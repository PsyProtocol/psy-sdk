...
impl Sub for RuntimeFelt {
    ...
    fn sub(self, other: Self) -> Self {
        RuntimeFelt(
            (GoldilocksField::from_noncanonical_u64(self.0)
                - GoldilocksField::from_noncanonical_u64(other.0))
            .to_canonical_u64(),
        )
    }
}
...
impl SubAssign for RuntimeFelt {
    fn sub_assign(&mut self, other: Self) {
        *self = RuntimeFelt(
            (GoldilocksField::from_canonical_u64(self.0)
                - GoldilocksField::from_canonical_u64(other.0))
            .0,
        )
    }
}
