...
use qed_crypto::hash::merkle::{spiderman::SpidermanUpdateProof, treeprover::{AggStateTrackableInput, AggStateTransition}};
use serde::{Deserialize, Serialize};

use crate::qdata::contract::QEDContractLeaf;
...
pub struct QCBatchDeployContractsCircuitInput<F: RichField> {
    ...
    pub contract_leaves: Vec<QEDContractLeaf<F>>,
}
