...
PROFILE := release
LOG_LEVEL := qed_rollup_utils=trace,tikv_client=warn,qed_store=trace,qed_user_cli=debug,qed_dev_cli=debug,qed_api_services=info,qed_rollup_cli=debug,qed_node=trace,qed_common_circuit=trace,qed_rollup_circuit=trace,qed_prover=trace,psy_data=trace,plonky2=error
...
WATCHED_DIRS := qed_rollup_circuit qed_common_circuit qed_prover/src/dpn qed_prover/src/ups psy_core/src/config/network_constants.rs psy_crypto/src/common/user_id.rs
