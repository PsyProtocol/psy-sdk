...
impl<KVQ: KVQBinaryStore> KVQArcImmutableStoreWrapper<KVQ> {
...
impl<KVQ: KVQBinaryStore> KVQBinaryStoreReader for KVQArcImmutableStoreWrapper<KVQ> {
...
impl<KVQ: KVQBinaryStore> KVQBinaryStoreWriter for KVQArcImmutableStoreWrapper<KVQ> {
...
impl<KVQ: KVQBinaryStore> KVQBinaryStoreWriterImmutable for KVQArcImmutableStoreWrapper<KVQ> {
