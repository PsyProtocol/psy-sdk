...
import { PsyWasmWebProverProvider, WasmRpcServer, PsyJSON, initWasmSync} from "@psy/psy-sdk";
...
const ExtensionHomeContent: React.FC = () => {
        ...
        return (
            <ErrorContainer>
                <div>
                    ...
                    <ErrorHint>
                        Make sure your local Psy node is running on port 8545
                    </ErrorHint>
                </div>
            </ErrorContainer>
        );
    ...
    return (
        <ExtensionContainer>
            <PsyWalletWidget provider={walletProvider} theme="extension">
                <TokensProvider>
                    <ExtensionContent />
                </TokensProvider>
            </PsyWalletWidget>
