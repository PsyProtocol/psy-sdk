...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h6fe65cc3c19c368f: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__h01b70a8a9d0ccfe6: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h09af4dba171008cb: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__ha8d6bbdc9a21904a: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h83ce7e88052f46bb: (a: number, b: number) => void;
