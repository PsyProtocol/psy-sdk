...
export const wasm_bindgen__closure__destroy__hfaaa40920e981734: (a: number, b: number) => void;
...
export const wasm_bindgen__convert__closures_____invoke__hc70f45b443d6e1aa: (a: number, b: number) => void;
