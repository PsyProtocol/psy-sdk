...
class RpcProvider {
    constructor(coordinatorConfig, realmConfig, userPerRealm) {
        this.coordinatorRpcProvider = new client.MultiCoordinatorRpcProvider(coordinatorConfig);
        this.realmRpcProvider = new client$1.MultiRealmRpcProvider(realmConfig, userPerRealm);
    }
    setUserId(userId) {
