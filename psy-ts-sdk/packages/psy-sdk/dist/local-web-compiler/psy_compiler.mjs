...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_measure_52555d98d3c0f41a = function () {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('psy_compiler_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
...
export { call_contract, compile_dargo_project, compile_project, compile_source, create_account, __wbg_init as default, deploy_contract, get_accounts, get_contract_abi, get_contracts, get_transaction_log, initSync, init_chain, init_logging, init_psy_ide, interpret_project, interpret_source, main, read_contract_state, read_imt_state, reset_chain };
