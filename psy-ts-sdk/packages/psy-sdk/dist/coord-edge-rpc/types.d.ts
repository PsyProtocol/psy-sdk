...
import { CheckpointSyncInfo, ContractCodeDefinition, QBCDeployContract, PsyCheckpointGlobalStateRoots, PsyCheckpointLeaf, PsyCheckpointSyncInfoCompact, PsyContractLeaf, PsyBlockState, PsyUserLeaf, ZKPublicKeyInfo } from "../types";
/**
 * Coordinator Edge RPC Command namespace
 */
export declare enum CoordinatorEdgeRPCCommand {
